			...
			<div className="row">
				<div className="col-xl-8">
					...
					<Panel>
						...
						<textarea className="form-control rounded-0 border-0 shadow-none bg-light p-3" defaultValue="Enter some comment."></textarea>
								...
								<div className="todolist-item active">
									<div className="todolist-input">
										<div className="form-check">
											<input type="checkbox" className="form-check-input" id="todolist1" data-change="todolist" checked />
										</div>
									</div>
