...
function EmailDetail(): React.ReactElement {
        ...
        <div className="mailbox-content-header">
          <div className="btn-toolbar">
            ...
            <div className="btn-group ms-auto me-2">
              <Link to="/email/inbox" className="btn btn-white btn-sm disabled">
            ...
            <div className="p-3">
              ...
              <div className="d-flex mb-3">
                ...
                <div className="ps-3">
                  ...
                  <div className="email-to">To: nguoksiong@live.co.uk</div>
                </div>
              </div>
              ...
              <ul className="attached-document clearfix">
                <li className="fa-file">
                  ...
                  <div className="document-name">
                    <Link to="/email/detail" className="text-decoration-none">
                      flight_ticket.pdf
                    </Link>
                  </div>
                </li>
              ...
              <p className="text-dark">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vel auctor nisi, vel
                auctor orci. <br />
                Aenean in pretium odio, ut lacinia tellus. Nam sed sem ac enim porttitor vestibulum
                vitae at erat.
              </p>
              <p className="text-dark">
                Curabitur auctor non orci a molestie. Nunc non justo quis orci viverra pretium id ut
                est. <br />
